...
# 构建项目
RUN dotnet build "./CouponService/CouponService.csproj" -c $BUILD_CONFIGURATION -o /app/build

# 发布阶段
FROM build AS publish
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "./CouponService/CouponService.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=false
